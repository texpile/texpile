	...
	{#if hidden.length > 0}
		<div class="shrink-0">
			...
			{#if menuOpen}
				...
				<div
					bind:this={menuEl}
					class="bg-surface-50-950 border-surface-300-700 fixed z-50 flex max-w-[min(22rem,calc(100vw-1rem))] flex-wrap items-center gap-3 gap-y-2 card border p-2 shadow-lg"
