...
{#if shownTip.current}
	<div
		bind:this={card}
		role="tooltip"
		class="border-surface-300-700 bg-surface-50-950 text-surface-700-200 z-tooltip pointer-events-none fixed max-w-xs rounded-base border px-2 py-1 text-xs whitespace-pre-line shadow-lg"
